...
function dividirYResiduo(a, b) {
    // Calcula el resultado de la división
    let resultado = Math.floor(a / b);
    // Calcula el residuo de la división
    let residuo = a % b;
    // Devuelve un array con el resultado y el residuo
    return [resultado, residuo];
}

// Ejemplo de uso
let resultado = dividirYResiduo(10, 3);
console.log(`Resultado: ${resultado[0]}, Residuo: ${resultado[1]}`); // Resultado: 3, Residuo: 1
